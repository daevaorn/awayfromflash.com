    ...
    RGraph.HBar.prototype.DrawBackground = function ()
    {
        ...
        if (this.Get('chart.background.grid')) {
            ...
            if (this.Get('chart.background.grid.autofit')) {
                var vsize = (this.canvas.width - (4 * this.Get('chart.gutter'))) / this.Get('chart.background.grid.autofit.numvlines');
                var hsize = (this.canvas.height - (4 * this.Get('chart.gutter'))) / this.Get('chart.background.grid.autofit.numhlines');
