    ...
    RGraph.Odometer.prototype.DrawNeedle = function ()
    {
        ...
        if (this.Get('chart.needle.type') == 'pointer') {
            ...
            this.context.beginPath();
                ...
                this.context.arc(this.centerx,this.centery,this.radius - this.Get('chart.label.area') - 35,(((this.Get('chart.value') / this.range) * 360) - 90) / 57.3,((((this.Get('chart.value') / this.range) * 360) - 90) / 57.3) + 0.01,0);
            this.context.closePath();
            this.context.stroke();
            this.context.fill();
            ...
            */
            this.context.beginPath();
                this.context.arc(this.centerx, this.centery, 5, 0, 6.28, 0);
            this.context.closePath();
            this.context.fill();
        }
        ...
        this.context.beginPath();
        this.context.fillStyle = 'black';
        this.context.arc(this.centerx, this.centery, 5, 0, 6.2830, 0);
        this.context.fill();
